...
namespace Order
{
    ...
    class Bakery_items
    {
        ...
        {
            Cust_details objectCust2 = new Cust_details();
            objectCust2.getName();
            Console.WriteLine("Hello {0}" , objectCust2.strName);
    ...
    class OrderTest 
    {
        ...
        {
            string choice;
            Console.WriteLine("What would you laike to order? 1-Grocery Items, 2- Bakery Items");
